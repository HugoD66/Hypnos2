 ...
 */
final class Version20220426133010 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE hotel (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, managedby_id INTEGER NOT NULL, name VARCHAR(255) NOT NULL, adress VARCHAR(255) NOT NULL, description CLOB NOT NULL, CONSTRAINT FK_3535ED9244413E0 FOREIGN KEY (managedby_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
